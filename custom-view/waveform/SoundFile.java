...
public class SoundFile {
    ...
    public static String[] getSupportedExtensions() {
        return new String[] {"mp3", "wav", "amr","m4a"};
    }
    ...
    private void ReadFile(File inputFile)
        ...
        codec.configure(format, null, null, MediaCodec.BUFFER_FLAG_END_OF_STREAM);
        codec.start();
    ...
    public void WriteFile(File outputFile, float startTime, float endTime)
        ...
        try {
            ...
            Log.e("Mp3 Cutter Master", "Failed to create the .m4a file.");
            Log.e("Mp3 Cutter Master", getStackTrace(e));
        }
    }
    ...
    private void DumpSamples(String fileName) {
        ...
        try {
            ...
            Log.w("Mp3 Cutter Master", "Failed to create the sample TSV file.");
            Log.w("Mp3 Cutter Master", getStackTrace(e));
        }
        // We are done here. Close the file and rewind the buffer.
        try {
            writer.close();
        } catch (Exception e) {
            Log.w("Mp3 Cutter Master", "Failed to close sample TSV file.");
            Log.w("Mp3 Cutter Masster", getStackTrace(e));
        }
        mDecodedSamples.rewind();
    }
