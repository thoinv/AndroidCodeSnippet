package com.videotomp3.audio.videoconverter.views.custom.fancybutton;
...
public class FancyButton  extends LinearLayout{
    ...
    private int mDefaultTextSize 				= FancyUtils.spToPx(getContext(), 15);
    private int mDefaultTextGravity             = 0x11; // Gravity.CENTER
    private String mText 						= null;

    // # Icon Attributes
    private Drawable mIconResource 				= null;
    private int  mFontIconSize 					= FancyUtils.spToPx(getContext(), 15);
    ...
    public FancyButton(Context context){
        ...
        mTextTypeFace   = FancyUtils.findFont(mContext, mDefaultTextFont, null);
        mIconTypeFace   = FancyUtils.findFont(mContext, mDefaultIconFont, null);
    ...
    private TextView setupTextView(){
        ...
        textView.setTextSize(FancyUtils.pxToSp(getContext(), mDefaultTextSize));
    ...
    private TextView setupFontIconView(){
        ...
        if(mFontIcon!=null){
            ...
            if(!isInEditMode()){
                fontIconView.setTextSize(FancyUtils.pxToSp(getContext(), mFontIconSize));
    ...
    private void initAttributesArray(TypedArray attrsArray){
        ...
        mRadiusTopLeft 					= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fb_top_left_radius, mRadiusTopLeft);
        mRadiusTopRight 			    = (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fb_top_right_radius, mRadiusTopRight);
        mRadiusBottomRight 				= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fb_bottom_right_radius, mRadiusBottomRight);
        mRadiusBottomLeft 				= (int)attrsArray.getDimension(R.styleable.FancyButtonsAttrs_fb_bottom_left_radius, mRadiusBottomLeft);
        ...
        if(!isInEditMode()){
            if(iconFontFamily!=null){
                mIconTypeFace = FancyUtils.findFont(mContext, iconFontFamily, mDefaultIconFont);
            }else{
                mIconTypeFace = FancyUtils.findFont(mContext, mDefaultIconFont, null);
            }

            if(textFontFamily!=null){
                mTextTypeFace = FancyUtils.findFont(mContext, textFontFamily, mDefaultTextFont);
            }else{
                mTextTypeFace = FancyUtils.findFont(mContext, mDefaultTextFont, null);
            }
        }
    ...
    private void setupBackground(){
        ...
        this.setDrawableRadius(defaultDrawable, mRadiusTopLeft, mRadiusBottomLeft, mRadiusTopRight, mRadiusBottomRight);
        if (mGhost){
        ...
        this.setDrawableRadius(focusDrawable, mRadiusTopLeft, mRadiusBottomLeft, mRadiusTopRight, mRadiusBottomRight);
        focusDrawable.setColor(mFocusBackgroundColor);

        // Disabled Drawable
        GradientDrawable disabledDrawable = new GradientDrawable();
        this.setDrawableRadius(disabledDrawable, mRadiusTopLeft, mRadiusBottomLeft, mRadiusTopRight, mRadiusBottomRight);
        ...
        if (mUseRippleEffect && Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            this.setDrawableRadius(drawable2, mRadiusTopLeft, mRadiusBottomLeft, mRadiusTopRight, mRadiusBottomRight);
            if (mGhost){
    ...
    private void setDrawableRadius(GradientDrawable drawable, float topLeft, float bottomLeft, float topRight, float bottomRight){
        Log.d(TAG, String.format(
                "setDrawableRadius: topLeft - %f | bottomLeft - %f | topRight - %f | bottomRight - %f", topLeft, bottomLeft, topRight, bottomRight));
    ...
    public void setText(int resourceId){
        this.setText(getContext().getString(resourceId));
    }
    ...
    public void setTextSize(int textSize){
        this.mDefaultTextSize = FancyUtils.spToPx(getContext(), textSize);
        if(mTextView != null)
    ...
    public void setFontIconSize(int iconSize){
        this.mFontIconSize = FancyUtils.spToPx(getContext(), iconSize);
        if(mFontIconView!=null)
    ...
    public void setRadius(float radiusTopLeft, float radiusTopRight, float radiusBottomRight, float radiusBottomLeft){
    ...
    public void setCustomTextFont(String fontName){
        mTextTypeFace = FancyUtils.findFont(mContext, fontName, mDefaultTextFont);
    ...
    public void setCustomIconFont(String fontName){
        ...
        mIconTypeFace = FancyUtils.findFont(mContext, fontName, mDefaultIconFont);
